...
class GetNdviImageByDayResponse(BaseModel):
    ...
    ndvi_max: float | None
    sat_image_id: str
    valid_pixels: int | None = Field(default=None, alias="validPixels")
    total_pixels: int | None = Field(default=None, alias="totalPixels")
    valid_percentage: float | None = Field(default=None, alias="validPercentage")
